...
export default function MainPage() {
    return (
        <div className="MainPage">
            ...
            <BreakingBox 
                title={(<h1>Mistillid i Alternativet, <br /> kan det blive godt igen?</h1>)}
                breakingText="BREAKING:"
                sitesrc={"./mistillid"}
                imgsrc=""
                color="yellow"
            ...
            <BreakingBox 
                title={(<h1>Er Corona en <br /> joke?</h1>)}
                breakingText="BREAKING:"
                sitesrc={"./corona"}
            ...
            <BreakingBox 
                title={(<h1>Ingen tillid i den <br /> rød- grønne alliance</h1>)}
                breakingText="BREAKING:"
                sitesrc={"./tillid"}
                imgsrc=""
                color="yellow"
            ...
            <BreakingBox 
                title={(<h1>På den ene side <br />har man de blå partier.</h1>)}
                breakingText=""
                sitesrc={"./blue"}
                imgsrc=""
                color="lightblue"
            ...
            <BreakingBox 
                title={(<h1>På den anden side<br /> har man de røde.</h1>)}
                breakingText=""
                sitesrc={"./red"}
                imgsrc=""
                color="red"
            ...
            <BreakingBox 
                title={(<h1>Der er også<br /> de grønne</h1>)}
                breakingText=""
                sitesrc={"./green"}
                imgsrc=""
                color="lightgreen"
            ...
            <BreakingBox 
                title={(<h1>For slet ikke at <br />nævne midterpartierne</h1>)}
                breakingText=""
                sitesrc={"./midter"}
                imgsrc=""
                color="lightpink"
            ...
            <BreakingBox 
                title={(<h1>Er de frie <br />grønne <br /> virkelig frie?</h1>)}
                breakingText=""
                sitesrc={"./ikkeFrie"}
